...
Established on 1 November 2000, we have handled several government affairs. The Managing Partner of MKA, Miko Kamal, Ph.D., has good relationship with local government and he also serves as a commissioner in a City-owned Company.
...
+622146776655 (phone) +62214243469 (facs)
 ...
 ">
    ...
    <!-- Title -->
    <title>We are ready to serve you – Public Governance – Private Governance – Litigation & Dispute Resolution</title>
...
<body>
    ...
    <div id="loader">
        <div class="laoder-frame">
            <img class="svg-loader" src="<?= $base_url ?>img/assets/loader.svg" alt="circle-loader">
        </div>
    </div>
    <div class="homepage">
        <?php
                ...
                <div class="row">
                    <div class="col-md-9 col-xs-12" data-aos="fade">
                        <article>
                          <div class="row">
                            <?php
                              $sql = mysqli_query($con, "SELECT * FROM tbl_berita WHERE judul LIKE '%$_GET[s]%'");
                            ...
                            ?>
                            <div class="item col-sm-6 p-b-40">
                                <div class="post row">
                                    <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12">
                                        <h3 style="font-size: 18px;"><a href="<?= $base_url ?>news/<?= $data['judulseo'] ?>"><?= $judul."..." ?></a></h3>
                                        <p><?= $deskripsi ?></p>
                                        <a class="read-more" href="<?= $base_url ?>news/<?= $data['judulseo'] ?>">Read More...</a>
                                    </div>
                                </div>
                            </div>
                            <?php
        ...
        <footer style="background-color: #083d1a;">
            <div class="container footer-widgets">
                <div class="row">
                  <aside class="col-md-12 text-center" data-aos="fade-up" data-aos-delay="0">
                    <h3 style="color:#c3c70a;" ><i>We offer all you need to get justice</i></h3>
                    <hr>
                  </aside>
                </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <br>
                      <ul class="text-light">
                        ...
                        ?>
                        <li class="text-light" style="margin-top: -10px;"><i class="fa fa-check-square"></i> <?= ucfirst($data1['judul_detail']) ?></li>
                        <br>
                        <?php } ?>
                      </ul>
                  </div>
            ...
            <div id="copyright" data-aos-delay="0" style="background-color: #a60202; height: 10px;">
