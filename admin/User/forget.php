...
<?php
  ...
  switch ($aksi){
	...
	$save=mysqli_query($con, "INSERT INTO tbl_forget
    VALUES('', '$_SESSION[id_client]','$_POST[jenis_kegiatan]','$_POST[kegiatan]','$_POST[tgl_kegiatan]','$_POST[jam_mulai]','$_POST[jam_akhir]','$_POST[keterangan]','$jumlah')");

	 if($save) {
        echo "<script>
            alert('Tambah Data Berhasil');
            window.location='?module=forget';
            </script>";
            exit;
      }else{
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Forgotten Activities</li>
      </ol>
</section>
<!-- Content Header (Page header) -->
            ...
            <form method="POST" class="form-horizontal" action="" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
						<label for="nohp" class="col-sm-2 control-label">Tanggal Kegiatan</label>
					  <div class="col-sm-8">
...
<?php
    ...
    case "editforget":
    if(isset($_GET['id'])){
      $sql = mysqli_query($con, "SELECT * FROM tbl_forget where idkegiatan='$_GET[id]'");
    ...
    if(isset($_POST['save'])){
      ...
      $save=mysqli_query($con, "UPDATE tbl_forget set jenis_kegiatan='$_POST[jenis_kegiatan]', kegiatan='$_POST[kegiatan]',tanggal_kegiatan='$_POST[tgl_kegiatan]', jam_mulai='$_POST[jam_mulai]', jam_akhir='$_POST[jam_akhir]',keterangan='$_POST[keterangan]',jumlah='$jumlah' where idkegiatan='$_GET[id]'");
      if($save) {
        echo "<script>
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Edit Forget</li>
      </ol>
</section>
       ...
       <div class="box box-info">
         <div class="box-header with-border">
		  ...
		  <div class="form-group">
            <label for="nohp" class="col-sm-2 control-label">Tanggal Kegiatan</label>
            <div class="col-sm-8">
            <input type="date" name="tgl_kegiatan" class="form-control" value="<?= $data[tanggal_kegiatan] ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="kdp" class="col-sm-2 control-label">Jenis kegiatan</label>
...
<?php
    ...
    if(isset($_GET['id'])){
      $lihat = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM tbl_forget where idkegiatan='$_GET[id]'"));

      $del = mysqli_query($con, "DELETE FROM tbl_forget where idkegiatan='$_GET[id]'");
      if($del){
    	  echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=forget';
    				  </script>";
      }else{
        echo "<script>
...
<section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <a href="?module=forget&aksi=tambahforget" class="btn btn-flat btn-primary">Tambah Forget </a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <th rowspan="2">Keterangan</th>
                ...
                <tbody>
				<?php
					$be = mysqli_query($con, "SELECT * FROM tbl_forget WHERE nama='$_SESSION[id_client]' order by idkegiatan desc");
					$no=1;
          ...
          <td><?= $r["keterangan"];?></td>
					...
					<td><a href="?module=forget&aksi=editforget&id=<?= $r['idkegiatan'];?>" class="btn btn-info">Edit</a>
				
						<a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini ?');" href="?module=forget&aksi=hapusforget&id=<?= $r['idkegiatan'];?>" class="btn btn-info">Hapus</a>
					</td>
				</tr>
					<?php $no++; } ?>
				</tfoot>
