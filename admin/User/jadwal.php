      ...
      if($del){
    	  echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=jadwal';
    				  </script>";
      }else{
        echo "<script>
...
<section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <a href="?module=jadwal&aksi=tambahJadwal" class="btn btn-flat btn-primary">Tambah Jadwal</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <td><?= tgl_indo($r["tgl_jadwal"]);?></td>
					...
					<td><a href="?module=jadwal&aksi=editJadwal&id=<?= $r['idjadwal'];?>" class="btn btn-info btn-xs">Edit</a>
						<a href="?module=jadwal&aksi=hapusJadwal&id=<?= $r['idjadwal'];?>" class="btn btn-info btn-xs">Hapus</a>
					</td>
				</tr>
					<?php $no++; } ?>
				</tfoot>
