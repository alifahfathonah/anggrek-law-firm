    ...
    if(isset($_POST['save'])){
      ...
      if($save) {
        echo "<script>
            ...
            window.location='?module=officeadmin';
              </script>";
        }else{
          echo "<script>alert('Gagal');
              </script>";
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Edit Beyond Office Hour
</section>
      ...
      if($del){
    	  echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=officeadmin';
    				  </script>";
      }else{
        echo "<script>
...
<section class="content-header">
     ...
     Beyond Office Hour
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Beyond Office Hour
</section>
<section class="content">
      <div class="row">
        <div class="col-md-12">
          ...
          <td><?= $r["nama_pengacara"];?></td>
					...
					<td><a href="?module=officeadmin&aksi=editoffice&id=<?= $r['idkegiatan'];?>" class="btn btn-info">Edit</a>
				
						<a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini ?');" href="?module=officeadmin&aksi=hapusoffice&id=<?= $r['idkegiatan'];?>" class="btn btn-info">Hapus</a>
					</td>
				</tr>
					<?php $no++; } ?>
				</tfoot>
